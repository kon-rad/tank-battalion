...
define(['game', 'tank', 'bullets', 'mWorld', 'images', 'audio', 'singlePlayer'],
	...
	const render_bullet = function render_bullet(bullet, bullet_index, bot_index) {
	...
	const checkBulletCollision = function checkBulletCollision(x, y, bullet_index, dir, bot_index) {
		y = Math.floor(y / 10);
		x = Math.floor(x / 10);
